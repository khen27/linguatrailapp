...
export const LearningConfigurationsIcon = ({ size = 20, color = '#356671' }: IconProps) => (
...
// Placeholder icons - you can provide the other SVGs and I'll add them
export const SubscriptionIcon = ({ size = 20, color = '#356671' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    <Path 
      d="M18.3335 5.41675H13.3335" 
      stroke={color} 
...
export const SupportIcon = ({ size = 20, color = '#356671' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    <Path 
      d="M18.3335 5.41675H13.3335" 
      stroke={color} 
...
export const DarkThemeIcon = ({ size = 20, color = '#356671' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    <Path 
      d="M18.3335 5.41675H13.3335" 
      stroke={color} 
...
export const NotificationsIcon = ({ size = 20, color = '#356671' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    <Path 
      d="M18.3335 5.41675H13.3335" 
      stroke={color} 
