          ...
          <View style={styles.lessonsContainer}>
            ...
            <View style={styles.lessonCard}>
              <View style={styles.cardHeader}>
                <View style={styles.iconContainer}>
                  <Svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                    <Circle cx="20" cy="20" r="18" fill="#F6F7FA" stroke="#E0E3EF" strokeWidth="0.5"/>
                    <Defs>
                ...
                <View style={styles.iconContainer}>
                  <Svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                    ...
                    <G clipPath="url(#clip0_4418_6692)">
                      <Path d="M28.3162 16.1833H11.6831C11.1665 16.1833 10.7665 15.7833 10.7665 15.2667C10.7665 14.75 11.1665 14.35 11.6831 14.35H28.3162C28.8331 14.35 29.2331 14.75 29.2331 15.2667C29.2331 15.7833 28.8331 16.1833 28.3162 16.1833Z" fill="#5C5C5C"/>
                      <Path d="M20 16.1833C19.4834 16.1833 19.0834 15.7833 19.0834 15.2667V12.1333C19.0834 11.6167 19.4834 11.2167 20 11.2167C20.5167 11.2167 20.9167 11.6167 20.9167 12.1333V15.2667C20.9167 15.7833 20.5167 16.1833 20 16.1833Z" fill="#5C5C5C"/>
